...
const UniqueNameGenerator = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Unique Baby Name Generator — Rare Names Filtered by Popularity"
        description="Free unique baby name generator. Filter by gender and rarity threshold to discover hidden-gem names from real birth-registry data."
        canonical="https://howmanyofme.co/tools/unique-name-generator"
        jsonLd={jsonLd}
      />
      <SiteHeader />
      ...
      <main className="container py-12 max-w-3xl">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          ...
          <Link to="/tools/random-name" className="text-primary hover:underline">Random Name Generator</Link>. Looking for meaning?{" "}
          <Link to="/tools/meaning" className="text-primary hover:underline">Name Meaning Lookup</Link> covers etymology and origin.
        </p>
