...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="How Many People Have My Name? Free Instant Checker 🌍"
        description="Find out how many people share your name worldwide in 1 second. Free name popularity, rarity & origin checker — 100M+ records, 80+ countries, no signup."
      ...
      <Suspense fallback={<div className="container py-16" />}>
        <HomeBelowFold popularNames={popularNames} />
      </Suspense>
