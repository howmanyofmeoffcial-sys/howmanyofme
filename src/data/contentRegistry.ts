...
const articleTagMap: Record<string, string[]> = {
  ...
  "baby-name-trends": ["trends", "baby names", "predictions", "popular names", "forecast"],
  ...
  "top-google-baby-name-searches": ["Google trends", "search data", "baby names", "popular names", "search volume"],
  ...
  "popular-baby-names-california": ["California", "popular names", "regional", "state data", "Hispanic"],
  "popular-baby-names-texas": ["Texas", "popular names", "regional", "state data", "Southern"],
