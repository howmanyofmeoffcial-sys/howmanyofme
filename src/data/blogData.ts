...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    title: "Baby Name Trends: Data-Driven Predictions for the Year Ahead",
    description: "Our data scientists predict the hottest baby name trends based on analysis of naming patterns, cultural shifts, and historical SSA data.",
    category: "trends",
    readTime: 9,
    date: "2026-01-20",
    content: [
