  ...
  return (
      <main className="container py-12 max-w-3xl">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          ...
          <Link href="/tools/unique-name-generator" className="text-primary hover:underline">Unique Name Generator</Link>. Looking up specific names?{" "}
          <Link href="/tools/popularity-checker" className="text-primary hover:underline">Popularity Checker</Link>.
        </p>
        ...
        <section className="mb-12 p-6 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-muted-foreground">
            A <strong>random name generator</strong> picks names at random from a database. The HowManyOfMe generator differs from AI tools in one critical way: every result is a <strong>real recorded human name</strong> sourced from the <a href="https://www.ssa.gov/oact/babynames/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">US Social Security Administration</a>, UK, and 78 other national birth registries — never an invented string. Get 10 names per click, optionally filtered by gender, with each result linking to its full popularity statistics. Want to <Link href="/" className="text-primary hover:underline">check how common your name is</Link>? Head to the homepage!
          </p>
        </section>
