      ...
      <main className="container py-12 max-w-5xl">
        ...
        <section className="mt-16 p-6 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-muted-foreground">
            A <strong>baby name trend visualizer</strong> is an interactive chart tool that plots multiple names on a single timeline so you can see how each name's popularity has risen, fallen, or stayed flat across decades. The HowManyOfMe visualizer supports up to <strong>4 names simultaneously</strong>, draws decade-by-decade lines from 1880 to today using <a href="https://www.ssa.gov/oact/babynames/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Social Security Administration</a> data, includes a <strong>country filter</strong> for US/UK/Canada/Australia, and uses normalized 0–100 popularity scores so trend shapes — not absolute counts — are easy to compare. Before diving deep into charts, you can <Link href="/" className="text-primary hover:underline">check how many people share your name</Link> to get a baseline.
          </p>
        </section>
        ...
        <section className="mt-20 space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground">
            ...
            <Link href="/tools/meaning" className="text-primary hover:underline">
              Name Meaning Lookup
            </Link>
            .
          </p>
