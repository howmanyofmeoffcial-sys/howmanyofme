  ...
  return (
      <main className="container py-12 max-w-3xl">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          ...
          <Link href="/tools/random-name" className="text-primary hover:underline">Random Name Generator</Link> or{" "}
          <Link href="/tools/unique-name-generator" className="text-primary hover:underline">Unique Name Generator</Link>.
        </p>
        ...
        <section className="mb-12 p-6 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-muted-foreground">
            A <strong>username generator</strong> is a free tool that takes a name (or word) and produces multiple styled handle variants — adding numbers, underscores, dots, prefixes or suffixes — to help you find an available username when your first choice is taken. The HowManyOfMe generator outputs <strong>8 distinct styles per click</strong>, all platform-safe (letters, numbers, dots, underscores only), suitable for platforms like <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Instagram</a>, <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">X</a>, and Twitch. After claiming your username, you can <Link href="/" className="text-primary hover:underline">check how common your actual name is</Link>.
          </p>
        </section>
