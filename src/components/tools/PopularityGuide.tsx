  ...
  return (
      <main className="container py-12 max-w-3xl">
        ...
        <p className="text-muted-foreground mb-2 text-lg">
          ...
          <Link href="/tools/popularity-checker" className="text-primary hover:underline">Name Popularity Checker</Link>.
        </p>
        <p className="text-sm text-muted-foreground mb-10">
          New here? Start with the{" "}
          <Link href="/tools/popularity-checker" className="text-primary hover:underline">Popularity Checker</Link> itself, then return for the deeper walkthrough below.
        </p>
        ...
        <section className="mb-10 p-6 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-muted-foreground">
            The <strong>Name Popularity Checker</strong> takes any first name and returns five attributes from official birth-registry data: <strong>global rank</strong>, <strong>estimated living bearers</strong>, <strong>decade-by-decade trend</strong>, <strong>gender distribution</strong> and <strong>country breakdown</strong>. This guide walks you through reading each metric in under five minutes. Our data is aggregated from international authorities like the <a href="https://unstats.un.org/unsd/demographic-social/sconcerns/migration/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">UN Statistics Division</a> and <a href="https://www.who.int/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">World Health Organization</a> life tables. Want to see a practical example? Head to the homepage to <Link href="/" className="text-primary hover:underline">find out how many people have your name</Link>.
          </p>
        </section>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <Link href="/tools/popularity-checker" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity">
            Try the Popularity Checker <ArrowRight className="h-4 w-4" />
          </Link>
          <Link href="/tools/name-comparison" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border bg-card font-semibold text-sm hover:bg-secondary transition-colors">
            Compare Two Names <ArrowRight className="h-4 w-4" />
          </Link>
          <Link href="/tools/trend-visualizer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border bg-card font-semibold text-sm hover:bg-secondary transition-colors">
