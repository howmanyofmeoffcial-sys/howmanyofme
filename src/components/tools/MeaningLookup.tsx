  ...
  return (
      <main className="container py-12 max-w-3xl">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          ...
          <Link href="/tools/name-comparison" className="text-primary hover:underline">Name Comparison</Link>. Looking for names with a specific meaning?{" "}
          <Link href="/tools/baby-names" className="text-primary hover:underline">Browse A–Z</Link>.
        </p>
        ...
        {result && (
          <div className="rounded-xl border border-border bg-card p-6 space-y-6 mb-12">
            ...
            <Link href={`/name/${result.name}`} className="inline-block text-sm text-primary hover:underline">View full name statistics →</Link>
          </div>
        )}
        ...
        <section className="mb-12 p-6 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-muted-foreground">
            A <strong>name meaning lookup</strong> tells you the language a name comes from (its <strong>origin</strong>) and what it translates to (its <strong>meaning</strong>). For example, 'Sophia' originates from Greek and means 'wisdom'. The HowManyOfMe lookup combines etymology with live popularity stats — so you see both meaning and current usage in one card. Many meanings are derived from <a href="https://www.oxfordreference.com/display/10.1093/acref/9780198610601.001.0001/acref-9780198610601" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Oxford's Dictionary of First Names</a> and linguistic research. Ready to see <Link href="/" className="text-primary hover:underline">how many people have your name</Link>?
          </p>
        </section>
