  ...
  return (
      <main className="container py-12 max-w-4xl">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          Wondering <Link href="/" className="text-primary hover:underline">how many people have my name</Link>? The search bar below focuses on trends, but our homepage shows global estimates. Need to compare two names? Try the{" "}
          <Link href="/tools/name-comparison" className="text-primary hover:underline">
        ...
        <form onSubmit={check} className="relative flex gap-3 mb-6">
          {showWarning && (
        ...
        {result && (
          <div className="rounded-xl border border-border bg-card p-6 mb-12">
            ...
            <Link href={`/name/${result.name}`} className="inline-block mt-6 text-sm text-primary hover:underline">
        ...
        <section className="mb-12 p-6 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-muted-foreground">
            A <strong>name popularity checker</strong> is a free online tool that uses official birth registry data to show how common a given first name is. It returns three core attributes: a <strong>global rank</strong>, an <strong>estimated number of living people</strong> who share the name, and a <strong>historical popularity score</strong> for each decade since 1880. The HowManyOfMe checker covers 100,000+ names across 80+ countries and updates annually with the newest <a href="https://www.ssa.gov/oact/babynames/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">SSA</a> and <a href="https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/livebirths" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">ONS data</a>. Want to <Link href="/" className="text-primary hover:underline">find out how common your name is</Link>? Just use the search bar above.
          </p>
        </section>
